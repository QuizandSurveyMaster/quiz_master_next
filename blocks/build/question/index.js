...
/* harmony default export */ __webpack_exports__["default"] = (SelectAddCategory);
...
/* harmony import */ var _component_FeaturedImage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../component/FeaturedImage */ "./src/component/FeaturedImage.js");
/* harmony import */ var _component_SelectAddCategory__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../component/SelectAddCategory */ "./src/component/SelectAddCategory.js");
/* harmony import */ var _component_icon__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../component/icon */ "./src/component/icon.js");
...
const isQuestionIDReserved = (questionIDCheck, clientIdCheck) => {
  ...
  return (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(blocksClientIds) ? false : blocksClientIds.some(blockClientId => {
    const {
      questionID
...
function Edit(props) {
  ...
  const isParentOfSelectedBlock = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => isSelected || select('core/block-editor').hasSelectedInnerBlock(clientId, true));
  ...
  const [enableCorrectAnsInfo, setEnableCorrectAnsInfo] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(!(0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(correctAnswerInfo));
  ...
  const selectedFileTypes = () => {
    ...
    return (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(file_types) ? [] : file_types.split(',');
  };
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (shouldSetID) {
      if ((0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(questionID) || '0' == questionID || !(0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(questionID) && isQuestionIDReserved(questionID, clientId)) {
        //create a question
        let newQuestion = (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmFormData)({
          "id": null,
          "rest_nonce": rest_nonce,
          "quizID": quizID,
          "quiz_name": quiz_name,
          "postID": post_id,
          "answerEditor": (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmValueOrDefault)(answerEditor, 'text'),
          "type": (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmValueOrDefault)(type, '0'),
          "name": (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmDecodeHtml)((0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmValueOrDefault)(description)),
          "question_title": (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmValueOrDefault)(title),
          "answerInfo": (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmDecodeHtml)((0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmValueOrDefault)(correctAnswerInfo)),
          "comments": (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmValueOrDefault)(commentBox, '1'),
          "hint": (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmValueOrDefault)(hint),
          "category": (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmValueOrDefault)(category),
          "multicategories": [],
          "required": (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmValueOrDefault)(required, 0),
          "answers": answers,
          "page": 0,
  ...
  }, [questionID, type, description, title, correctAnswerInfo, commentBox, category, multicategories, hint, featureImageID, featureImageSrc, answers, answerEditor, matchAnswer, required, settings]);
  ...
  const getCategoryAncestors = (termId, categories) => {
    let parents = [];
    if (!(0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(categories[termId]) && '0' != categories[termId]['parent']) {
    ...
    return (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmUniqueArray)(parents);
  };
  ...
  const setUnsetCatgory = (termId, categories) => {
    let multiCat = (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(multicategories) || 0 === multicategories.length ? (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(category) ? [] : [category] : multicategories;
    ...
    multiCat = (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmUniqueArray)(multiCat);
    setAttributes({
      category: '',
  ...
  const setQuestionType = qtype => {
    if (!(0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(MicroModal) && !proActivated && ['15', '16', '17'].includes(qtype)) {
      //Show modal for advance question type
      let modalEl = document.getElementById('modal-advanced-question-type');
      if (!(0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(modalEl)) {
  ...
  const insertNewQuestion = () => {
    if ((0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(props?.name)) {
      console.log("block name not found");
      return true;
    }
    const blockToInsert = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_6__.createBlock)(props.name);
  ...
  //insert new Question
  const insertNewPage = () => {
    const blockToInsert = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_6__.createBlock)('qsm/quiz-page');
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.BlockControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.ToolbarGroup, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.ToolbarButton, {
    icon: "plus-alt2",
  ...
  }))), isOpenAdvanceQModal && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.Modal, {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Cancel', 'quiz-master-next')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.Button, {
    variant: "primary",
    onClick: () => {}
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.ExternalLink, {
    ...
    help: (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(qsmBlockData.question_type_description[type]) ? '' : qsmBlockData.question_type_description[type] + ' ' + notes,
    __nextHasNoMarginBottom: true
  }, !(0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(qsmBlockData.question_type.options) && qsmBlockData.question_type.options.map(qtypes => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("optgroup", {
  ...
  }, qtype.name))))), ['0', '4', '1', '10', '13'].includes(type) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.SelectControl, {
    ...
    checked: !(0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(required) && '1' == required,
    onChange: () => setAttributes({
      required: !(0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmIsEmpty)(required) && '1' == required ? 0 : 1
    })
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.ToggleControl, {
  ...
  })), '11' == type && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.PanelBody, {
  ...
  }, qsmBlockData.file_upload_type.heading), Object.keys(qsmBlockData.file_upload_type.options).map(filetype => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.CheckboxControl, {
    key: 'filetype-' + filetype,
    label: fileTypes[filetype],
    checked: isCheckedFileType(filetype),
    onChange: () => setFileTypes(filetype)
  }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_component_SelectAddCategory__WEBPACK_IMPORTED_MODULE_9__["default"], {
    ...
    onChange: hint => setAttributes({
      hint: (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmStripTags)(hint)
    })
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.PanelBody, {
    ...
    initialOpen: true
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_component_FeaturedImage__WEBPACK_IMPORTED_MODULE_8__["default"], {
    featureImageID: featureImageID,
    ...
    onChange: title => setAttributes({
      title: (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmStripTags)(title)
    }),
    allowedFormats: [],
    ...
    value: (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmDecodeHtml)(description),
  ...
  }), !['8', '11', '6', '9'].includes(type) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InnerBlocks, {
    allowedBlocks: ['qsm/quiz-answer-option'],
    template: QUESTION_TEMPLATE
  }), enableCorrectAnsInfo && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.RichText, {
    tagName: "p",
    ...
    value: (0,_helper__WEBPACK_IMPORTED_MODULE_11__.qsmDecodeHtml)(correctAnswerInfo),
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Add New Question', 'quiz-master-next'))))));
}
