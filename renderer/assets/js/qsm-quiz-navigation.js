    ...
    QSMPagination = {
        Navigation: {
            ...
            initQuiz: function(quizId, $quizContainer,initialPage) {
                ...
                // Progress Bar
                if (QSMPagination && QSMPagination.ProgressBar) {
                    QSMPagination.ProgressBar.initProgressBar(
                        quizId,
                        $quizContainer,
                        quizObj.form
                    );
            ...
            startQuiz: function(quizId) {
                ...
                if (QSMPagination && QSMPagination.Timer) {
                    QSMPagination.Timer.start(quizId);
                }
            ...
            submitForm: function(quizId) {
                ...
                let timerInfo = QSMPagination && QSMPagination.Timer ? 
                            QSMPagination.Timer.getTimerInfo(quizId) : null;
                if (timerInfo) {
                ...
                if (QSMPagination && QSMPagination.Timer) {
                    QSMPagination.Timer.endTimer(quizId);
                }
