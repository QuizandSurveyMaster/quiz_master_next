...
function qsm_question_title_func( $question, $question_type = '', $new_question_title = '', $question_id = 0 ) {
	...
	?>
	<div class='mlw_qmn_question <?php echo esc_attr( $polar_extra_class ); ?> <?php echo esc_attr( $fill_in_blank_extra_class ); ?>' >
