		...
		if ( is_array( $answers ) ) {
			...
			foreach ( $answers as $answer_index => $answer ) {
				...
				if ( '' !== $answer[0] ) {
					...
					?>
					<input type='radio' class='qmn_quiz_radio qmn_radio_answers_new' name="<?php echo esc_attr( 'question' . $id ); ?>" id="<?php echo esc_attr( 'question' . $id . '_' . $mlw_answer_total ); ?>" value="<?php echo esc_attr( $answer_index ); ?>" />
