	...
	public function admin_notice() {
		...
		if ( stristr( network_site_url( '/' ), 'dev' ) !== false || stristr( network_site_url( '/' ), 'localhost' ) !== false || stristr( network_site_url( '/' ), ':8888' ) !== false ) {
			...
			echo '<div class="updated">';
				...
				echo '<p><a href="'.qsm_get_plugin_link('what-the-plugin-tracks', 'tracking-notice').'" target="_blank">' . esc_html__( 'Click here to learn more about why we need this data and what we collect', 'quiz-master-next' ) . '</a></p>';
