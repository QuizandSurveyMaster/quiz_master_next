...
function mlw_options_option_tab_content()
{
  ...
  // If nonce is correct, save options
  if ( isset( $_POST["save_options_nonce"] ) && wp_verify_nonce( $_POST['save_options_nonce'], 'save_options') ) {
  ...
  <form action="" method="post">
    ...
    <input type="hidden" name="quiz_id" value="<?php echo $quiz_id; ?>">
	  <button id="save_options_button" class="button-primary"><?php _e('Save Options', 'quiz-master-next'); ?></button>
