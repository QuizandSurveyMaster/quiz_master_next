...
function qsm_question_bank_initialize_question( $row, $header_map, $line ) {
	...
	return array(
		...
		'answer_info'             => qsm_question_bank_get_value( $row, $header_map, 'correct_answer_info', qsm_question_bank_get_value( $row, $header_map, 'answer_info', qsm_question_bank_get_value( $row, $header_map, 'question_answer_info' ) ) ),
