...
function qsm_reporting_analysis_tabs_content() {
	...
	<div class="qsm-upgrade-box">
		...
		<div class="qsm-upgrade-buttons" style="flex-wrap: nowrap;margin-left:-3px;width:75%;">
			<a href="<?php echo esc_url( qsm_get_plugin_link( 'pricing', 'quiz-list-page' ) ); ?>" target="_blank" class="qsm-popup__btn qsm-popup__btn-primary qsm_bundle" style="width: 100%;"  rel="noopener"><?php esc_html_e( 'Upgrade to QSM Bundle', 'quiz-master-next' ); ?></a>
			<a href="<?php echo esc_url( qsm_get_plugin_link( 'downloads/results-analysis', 'quiz-list-page' ) ); ?>" target="_blank" class="qsm_report_analysis" style="margin-left:60px;margin: 0 15px;color: #1D4ED8;text-decoration: none;font-weight: bold;font-size: 17px;width: 100%;text-align: center;margin-top: 5px;" rel="noopener" ><?php esc_html_e( 'Buy Report & Analysis Addon', 'quiz-master-next' ); ?></a>
		</div>
	</div>
	<?php
}
