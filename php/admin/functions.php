...
?>
<div class="qsm-popup qsm-popup-slide qsm-standard-popup qsm-popup-upgrade" id="<?php echo esc_attr( $qsm_pop_up_arguments['popup_id'] ); ?>" aria-hidden="false"
	style="display:none">
	<div class="qsm-popup__overlay" tabindex="-1">
	<div class="qsm-popup__container qsm-popup-upgrade-container" role="dialog" aria-modal="true" aria-labelledby="modal-export-import-title">
...
<h2><?php echo esc_html( $qsm_pop_up_arguments['popup_title'] ); ?></h2>
<?php
$read_icon_image             = plugins_url('', dirname(__FILE__)) . '/images/read_icon.png';
?>
<div class="qsm-upgrade-text qsm-popup-upgrade-text"><?php echo esc_html( $qsm_pop_up_arguments['popup_description'] ); ?></div>
<span  class="qsm-upgrade-read-icon">
	<img src= <?php echo esc_url( $read_icon_image ); ?> alt="read">&nbsp;<a href="<?php echo esc_url(qsm_get_plugin_link('docs/'.$qsm_pop_up_arguments['popup_doc_link'],
...
<div class="qsm-popup-upgrade-info"><img  src= <?php  echo esc_url( $qsm_pop_up_arguments['popup_information'] );?> alt="information"></div>
<div  class="qsm-upgrade-buttons-div">
	...
	target="_blank" class="qsm_export_import"  rel="noopener" ><?php echo esc_html( $qsm_pop_up_arguments['popup_addon_name'] ); ?></a>
</div>
</div>
</div>
</div>
