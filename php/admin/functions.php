...
?>
	<div class="qsm-popup__overlay" tabindex="-1" data-micromodal-close>
	<div class="qsm-popup__container" role="dialog" aria-modal="true" aria-labelledby="modal-export-import-title" style="padding:10px">
...
<img src= <?php echo $read_icon_image; ?> alt="read">&nbsp;<a href="<?php echo esc_url( qsm_get_plugin_link( 'docs/'.$qsm_pop_up_arguments['popup_doc_link'], 'quiz-help-box', 'add-ons' ) ); ?>" target="_blank" rel="noopener" ><?php esc_html_e('Read Documentation', 'quiz-master-next' ); ?></a>
...
<a href="<?php echo esc_url( qsm_get_plugin_link('downloads/'.$qsm_pop_up_arguments['popup_addon_link'], 'quiz-list-page')); ?>"   target="_blank" class="qsm_export_import"  rel="noopener" ><?php echo $qsm_pop_up_arguments['popup_addon_name']; ?></a>
</div>
</div>
	</div>
</div>
