...
<img src= <?php echo $read_icon_image; ?> alt="read">&nbsp;<a href="<?php echo esc_url( qsm_get_plugin_link( 'docs/'.$qsm_pop_up_arguments['popup_doc_link'], 'quiz-help-box', 'add-ons' ) ); ?>" target="_blank" rel="noopener" >Read Documentation</a>
