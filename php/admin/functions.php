...
?>
<div class="qsm-upgrade-text" style="padding-top:none;font-size:13px;"><?php echo  esc_html( $qsm_pop_up_arguments['popup_description'] ); ?></div>
...
<div class="qsm-upgrade-chart"><img  style="width:100%" src= <?php echo  esc_html( $qsm_pop_up_arguments['popup_chart_image'] );?> alt="chart"></div>
<div style="margin-top:20px;"><img  style="width:100%" src= <?php  echo esc_html( $qsm_pop_up_arguments['popup_information'] );?> alt="information"></div>
