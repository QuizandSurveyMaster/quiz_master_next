...
?>
<div class="qsm-popup qsm-popup-slide qsm-standard-popup qsm-popup-upgrade" id="<?php echo  $qsm_pop_up_arguments['popup_id']; ?>" aria-hidden="false" 
	style="display:none">
...
?>
<div class="qsm-upgrade-text qsm-popup-upgrade-text"><?php echo  $qsm_pop_up_arguments['popup_description']; ?></div>
...
<div class="qsm-upgrade-chart"><img src= <?php echo  $qsm_pop_up_arguments['popup_chart_image'];?> alt="chart"></div>
<div class="qsm-popup-upgrade-info"><img  src= <?php  echo $qsm_pop_up_arguments['popup_information'];?> alt="information"></div>
