...
add_filter( 'bulk_actions-edit-qsm_quiz', 'qsm_quiz_edit_bulk_actions', 9999, 1 );

function qsm_quiz_edit_bulk_actions( $bulk_actions ) {
...
add_filter( 'handle_bulk_actions-edit-qsm_quiz', 'qsm_quiz_bulk_action_handler', 10, 3 );
