...
class QMNGlobalSettingsPage {
	...
	public function quiz_default_global_option_init() {
		...
		add_settings_field( 'Do-not-allow-quiz-submission-after-the-end-datetime', __( 'Do not allow quiz submission after the end date/time', 'quiz-master-next' ), array( $this, 'qsm_global_Do_not_allow_quiz_submission_after_the_end_datetime' ), 'qsm_default_global_option', 'qmn-global-section' );
