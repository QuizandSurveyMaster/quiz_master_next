<?php
/**
 * Template for horizontal multiple choice type question
 *
 * This template can be overridden by copying it to yourtheme/qsm/templates/questions/multiple-choice-horizontal.php
 *
 * @package QSM
 * @version 11.0.0
 */
...
$answerEditor       = isset( $question_settings['answerEditor'] ) ? $question_settings['answerEditor'] : 'text';
...
$class_object->display_question_title( $question_text, 'horizontal_multiple_choice', $new_question_title, $id );
?>
<fieldset>
    <legend></legend>
