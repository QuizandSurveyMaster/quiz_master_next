	...
	public function qsm_admin_notices() {
		...
		if ( ! $multiple_categories ) {
			...
			<div class="notice notice-info multiple-category-notice" style="display:none;">
				...
				<p><?php esc_html_e( 'QSM has been updated! We need to upgrade your database so that you can enjoy the latest features.<br/>Please note that this action <b> can not be </b> rolled back. We recommend you to take a backup of your current site before proceeding.', 'quiz-master-next' ); ?></p>
