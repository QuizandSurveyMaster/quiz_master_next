	...
	*/
	...
	public function qsm_add_admin_capabilty(){
		if ( class_exists( 'QSM_User_Role' ) ) {
			...
			$rolecaps->add_cap( 'edit_other_quizzes' ); 
			$rolecaps->add_cap( 'publish_quizzes' ); 
			$rolecaps->add_cap( 'read_quiz' ); 
			...
			$rolecaps->remove_cap( 'edit_other_quizzes' ); 
			$rolecaps->remove_cap( 'publish_quizzes' ); 
			$rolecaps->remove_cap( 'read_quiz' ); 
			$rolecaps->remove_cap( 'read_private_quizzes' ); 
